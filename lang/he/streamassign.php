...
$string['maxvideos'] = 'מספר מקסימלי של קבצי וידאו להגשה';
$string['maxvideos_help'] = 'מספר קבצי הווידאו המקסימלי שכל סטודנט יכול להגיש למטלה זו. כאשר מוגדר 1 ומותרת הגשה מחדש, הגשה חדשה מחליפה את הקודמת.';
$string['maxvideosadmin'] = 'תקרת מספר וידאו';
$string['maxvideosadmin_desc'] = 'הערך המקסימלי שמורים יכולים להגדיר בשדה "מספר מקסימלי של קבצי וידאו להגשה" (ברירת מחדל 20, בדומה למטלה רגילה).';
$string['submissionlimit'] = 'מגבלת הגשה';
$string['submissioncount'] = '{$a->count} מתוך {$a->max} סרטונים הוגשו';
$string['maxvideosreached'] = 'הגעת למספר המקסימלי של {$a} סרטון/ים למטלה זו.';
$string['videodalreadysubmitted'] = 'סרטון זה כבר הוגש למטלה זו.';
...
$string['uploadtoolarge'] = 'הקובץ חורג מהגודל המקסימלי ({$a}).';
$string['maximumsubmissionsize'] = 'גודל הגשה מקסימלי';
$string['maximumsubmissionsize_help'] = 'סטודנטים יכולים להעלות קבצים עד גודל זה. המגבלה לא יכולה לחרוג ממגבלת ההעלאה של האתר או הקורס.';
$string['configmaxbytes'] = 'גודל הגשה מקסימלי ברירת מחדל למטלות Stream חדשות.';
$string['allowedfiletypes'] = 'סוגי קבצים מותרים';
$string['allowedfiletypes_help'] = 'בחרו אילו סוגי קבצי מדיה סטודנטים יכולים להגיש. קבוצת Video לווידאו בלבד, Audio לאודיו בלבד, או שניהם. ניתן גם לבחור פורמטים בודדים כמו MP4 או MP3.';
$string['configfiletypes'] = 'סוגי קבצים מותרים ברירת מחדל למטלות Stream חדשות.';
$string['allowedformatstypes'] = 'סוגי קבצים מותרים במטלה זו:';
$string['videotitle'] = 'כותרת הוידאו (אופציונלי)';
$string['videotitle_help'] = 'כותרת הוידאו במערכת Stream. אם ריק, ישתמש בשם הקובץ.';
$string['allowedformats'] = 'פורמטים נתמכים: MP4, WebM, MKV, AVI, MOV, MP3, WAV, M4A, AAC, OGG ופורמטי וידאו/אודיו נפוצים אחרים.';
...
$string['grade'] = 'ציון';
$string['deletesubmission'] = 'מחק הגשה';
$string['deletesubmissionconfirm'] = 'האם למחוק את ההגשה "{$a->title}" של {$a->student}? הסרטון יישאר במערכת Stream; רק רשומת ההגשה במודל תימחק.';
$string['submissiondeleted'] = 'ההגשה נמחקה.';
$string['submittedby'] = 'הוגש על ידי {$a}';
$string['submittedbyyou'] = 'הוגש על ידך';
